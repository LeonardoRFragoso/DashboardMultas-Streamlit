...
def render_indicators(data, filtered_data, data_inicio, data_fim):
    ...
    try:
        ...
        with cols[0]:
            ...
            st.subheader("Pré-visualização das Multas")
        ...
        with cols[1]:
            ...
            # Exibir tabela de pré-visualização
            st.subheader("Pré-visualização do Valor Total das Multas")
        ...
        with cols[2]:
            ...
            st.subheader("Pré-visualização das Multas no Ano Atual")
        ...
        with cols[3]:
            ...
            # Exibir tabela de pré-visualização
            ano_data = unique_fines[unique_fines[9].dt.year == ano_atual]
            st.subheader("Pré-visualização do Valor das Multas no Ano Atual")
        ...
        with cols[4]:
            ...
            st.subheader("Pré-visualização das Multas no Mês Atual")
        ...
        with cols[5]:
            ...
            st.subheader("Pré-visualização do Valor das Multas no Mês Atual")
